...
from astfnet.models.loss_fns import AMSELoss, EffectiveRegionWeightedMSELoss, NonZeroWeightedMSE, WeightedMSE
...
def test_effective_region_weighted_mse() -> None:
...
def test_nonzero_weighted_mse() -> None:
